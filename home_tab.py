...
def display_home():
    ...
    with st.container():
        ...
        st.write("""
            ...
            Future pain and suffering refers to the ongoing physical and emotional suffering that an individual will endure in the future due to an injury or condition that has already occurred. Assessing future pain and suffering involves evaluating medical opinions on long-term injury impacts, including chronic pain and lifestyle restrictions. Lawyers use this information to predict how pain will affect a client’s daily life and future well-being. Estimating monetary compensation for future pain and suffering involves expert medical testimony and personal evidence, like pain journals, which help when negotiating with insurance companies. 
